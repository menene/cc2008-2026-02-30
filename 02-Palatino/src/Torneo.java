public class Torneo {
    ...
    public String resumen() {
        ...
        int totalGoles = e1.getGoles()
                + e2.getGoles()
                + e3.getGoles()
                + e4.getGoles()
                + e5.getGoles();

        int totalTirosEsquina = e1.getTirosEsquina()
                + e2.getTirosEsquina()
                + e3.getTirosEsquina()
                + e4.getTirosEsquina()
                + e5.getTirosEsquina();

        int totalTarjetasAmarillas = e1.getTarjetasAmarillas()
                + e2.getTarjetasAmarillas()
                + e3.getTarjetasAmarillas()
                + e4.getTarjetasAmarillas()
                + e5.getTarjetasAmarillas();

        int totalTarjetasRojas = e1.getTarjetasRojas()
                + e2.getTarjetasRojas()
                + e3.getTarjetasRojas()
                + e4.getTarjetasRojas()
                + e5.getTarjetasRojas();
        ...
        texto += "Total de tarjetas amarillas: "
